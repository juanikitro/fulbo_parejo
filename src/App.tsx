...
export default function App() {
  ...
  if (!sessionReady) return <main className="app-shell"><header className="topbar"><h1 className="brand-wordmark">Fulbo<em>Parejo</em></h1><ThemeSelector preference={themePreference} onChange={changeThemePreference} /></header><section className="panel"><h2>Cargando tu vestuario…</h2></section></main>
